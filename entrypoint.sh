...
# pywebpush: --ignore-installed cryptography avoids "Cannot uninstall cryptography, RECORD file not found" (Debian apt package)
pip3 install "pywebpush>=1.14.0" --ignore-installed cryptography || true
